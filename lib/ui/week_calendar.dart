...
class WeekCalendar extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => WeekCalendarState();
}
  ...
  build(BuildContext context) {
    return TableCalendar(
      ...
      onDaySelected: (dateTime, events) {
        if (widget.onSelected != null) widget.onSelected(dateTime);
      },
    );
  }
  ...
  Widget dayBuilder(
    ...
    TextStyle changeColorIfOutside(TextStyle textStyle) {
      return isOutsideMonth ||
              dateTime.isBefore(widget.weekConfig.startSchoolYear) ||
              dateTime.isAfter(widget.weekConfig.endSchoolYear
